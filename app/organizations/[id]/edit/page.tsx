...
export default function EditOrganizationPage({ params }: { params: { id: string } }) {
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    <p className="text-slate-700 font-semibold mb-4">No tienes permisos para editar esta organización.</p>
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 py-10">
            ...
            <h1 className="text-3xl font-bold text-slate-900 mb-8">Editar Perfil de Organización</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
                ...
                <div className="border-t border-slate-100 pt-6">
                    <div className="flex items-center justify-between mb-4">
                        <label className="text-sm font-bold text-slate-700">Métodos de contacto</label>
                        <button
                            type="button"
                            onClick={addContact}
                    ...
                    {contacts.length === 0 && (
                        <p className="text-sm text-slate-400 italic">No has agregado métodos de contacto aún.</p>
                    )}
                        ...
                        {contacts.map((contact, idx) => (
                            <div key={idx} className="flex gap-2 items-center">
                                ...
                                <input
                                    ...
                                    placeholder={
                                        contact.type === 'email' ? 'org@pucp.edu.pe' :
                                        contact.type === 'whatsapp' ? '+51 999 999 999' :
                                        'https://...'
                                    }
                                />
                                <button
