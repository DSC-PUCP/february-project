...
export default function EditEventPage({ params }: { params: Promise<{ id: string }> }) {
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    <p className="text-slate-700 font-semibold mb-4">No tienes permisos para editar este evento.</p>
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
                {/* Título */}
                <div>
                ...
                <div>
                    ...
                    />
                    <p className="text-xs text-slate-400 mt-1">O actualiza la URL directamente:</p>
                    <input
                        type="url"
                        value={bannerUrl}
                        onChange={(e) => { setBannerUrl(e.target.value); if (!bannerFile) setPreviewUrl(e.target.value); }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-bold text-slate-700 mb-2">Fecha y hora de inicio *</label>
                        <input
                            type="datetime-local"
                            required
                            value={startDate}
                    ...
                    <div>
                        <label className="block text-sm font-bold text-slate-700 mb-2">Fecha y hora de fin *</label>
                        <input
                            type="datetime-local"
                            required
                            value={endDate}
                ...
                {categories.length > 0 && (
                    <div>
                        <label className="block text-sm font-bold text-slate-700 mb-3">Categorías</label>
                ...
                <div className="border-t border-slate-100 pt-6">
                    <h3 className="text-sm font-bold text-slate-700 mb-4">Contacto de Inscripción (opcional)</h3>
                    <div className="space-y-4">
                        <div>
                            <label className="block text-xs font-semibold text-slate-500 mb-1">Link de inscripción</label>
                            <input
                                type="url"
                        ...
                        <div>
                            <label className="block text-xs font-semibold text-slate-500 mb-1">Número de WhatsApp</label>
                            <input
                                type="text"
